...
splunk init shcluster-config -auth admin:changeme -mgmt_uri "https://$IPADDR:8089" -replication_port 8191 -conf_deploy_fetch_url https://10.10.50.165:8089 -secret vagrant
splunk restart
